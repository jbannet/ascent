...
import '../../../widgets/onboarding/question_input/height_selector_widget.dart';
...
class HeightQuestion extends OnboardingQuestion {
  ...
  @override
  Map<String, dynamic> get config => {'isRequired': false};
  ...
  /// Get total height in inches as a double
  double? get heightInches {
    final data = _heightData;
    if (data == null) return null;
    final feet = data['feet'];
    final inches = data['inches'];
    if (feet is int && inches is int) {
      return (feet * 12 + inches).toDouble();
    }
    return null;
  }

  /// Get height in meters as a double
