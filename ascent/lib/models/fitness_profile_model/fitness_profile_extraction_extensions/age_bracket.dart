...
extension AgeBracket on FitnessProfile {
  ...
  void calculateAgeBracket() {
    ...
    if (dateOfBirth == null) {
      throw Exception(
        'Missing required answer for age bracket calculation: dateOfBirth=$dateOfBirth',
      );
    }
    ...
    featuresMap[FeatureConstants.ageBracket20To29] =
        (age >= 20 && age <= 29) ? 1.0 : 0.0;
    featuresMap[FeatureConstants.ageBracket30To39] =
        (age >= 30 && age <= 39) ? 1.0 : 0.0;
    featuresMap[FeatureConstants.ageBracket40To49] =
        (age >= 40 && age <= 49) ? 1.0 : 0.0;
    featuresMap[FeatureConstants.ageBracket50To59] =
        (age >= 50 && age <= 59) ? 1.0 : 0.0;
    featuresMap[FeatureConstants.ageBracket60To69] =
        (age >= 60 && age <= 69) ? 1.0 : 0.0;
